...
5. Если найдена выдуманная сторона — is_valid = false.
6. Если найдено неподтвержденное требование — is_valid = false.
...

{
  ...
  "invented_parties": [
    {
      "party": "Выдуманная сторона",
      "reason": "Почему сторона не подтверждена"
    }
  ],
  "unsupported_demands": [
    {
